...
public class SocketIOManager
{
    ...
    public void startSIO()
    {
        try
        {
            ...
            Globals.Config.u_SIO = "https://sio.topbangkokclub.com/test";
                ...
                case "banner":
                    {
                      ...
                      JArray arrData = (JArray)data["data"];
                        ...
                        Globals.Config.preloadBannerOnList();
    ...
    void emitSIO(string strData)
    {
        ...
        {
            //Debug.Log("-=-=emitSIO  data: " + strData);
            if (!IsJSON(strData))
            {
