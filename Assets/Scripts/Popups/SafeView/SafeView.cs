...
public class SafeView : BaseView
{
    ...
    public void onClickPushToSafe()
    {
        ...
        lbTypeTrans.text = Globals.Config.getTextConfig("txt_push_to_safe");
    ...
    public void onClickWithDraw()
    {
        ...
        transactionView.SetActive(true);
        buttonContainer.SetActive(false);
        lbTypeTrans.text = "Withdraw:";
        lbTypeTrans.text = Globals.Config.getTextConfig("txt_with_draw");
    ...
    public void reloadHistory(JArray jsonData)
    {
        ...
        for (int i = 0; i < size; i++)
        {
            ...
            {
                item = Instantiate(scrHistory.content.GetChild(0)).gameObject;
                item.transform.SetParent(scrHistory.content);
