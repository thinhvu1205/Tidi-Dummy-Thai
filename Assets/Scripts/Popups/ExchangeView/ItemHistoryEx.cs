...
public class ItemHistoryEx : MonoBehaviour
{
    ...
    public void setInfo(JObject _dataItem, int chip)
    {
        ...
        Debug.Log("(double)dataItem[CreateTime]" + (double)dataItem["CreateTime"]);
        ...
        txtAmount.text = Globals.Config.FormatNumber((int)dataItem["CashValue"]);
        txtPrice.text = Globals.Config.FormatNumber(chip);
