...
public class AlertMessage : MonoBehaviour
{
    ...
    public void showAlertMessage()
    {
        ...
        if (listData.Count > 0 && !UIManager.instance.isLoginShow())
        {
            ...
            {
                lbAlert.transform.localPosition = new Vector2(parentRect.width / 2, 0);
                posEnd = new Vector2(-parentRect.width / 2 - lbAlert.preferredWidth, 0);
            }
            else
            {
                lbAlert.transform.localPosition = new Vector2(parentRect.height / 2, 0);
                posEnd = new Vector2(-parentRect.height / 2 - lbAlert.preferredWidth, 0);
            }
