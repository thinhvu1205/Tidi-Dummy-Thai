...
public class Card : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{
    ...
    public void setTextureWithCode(int cod, bool isSmall = false)
    {
        try
        {
            code = cod;
            if (code == Globals.Config.CODE_JOKER_RED || code == Globals.Config.CODE_JOKER_BLACK)
            {
                ...
                imgSuitLarge.sprite = UIManager.instance.cardAtlas.GetSprite("card_joker");
    ...
    int encodeCard()
    {
        ...
        if (N == Globals.Config.CODE_JOKER_RED || N == Globals.Config.CODE_JOKER_BLACK)
            return N;
        //if (Globals.Config.curGameId === GAME_ID.SHAN_CLUB) return 13 * (S - 1) + N;
        return 13 * (S - 1) + N - 1;
    }
    void decodeCard(int cod)
    {
        code = cod;
    ...
    System.Action<PointerEventData, Card> OnBeginDragCallback, OnDragCallback, OnEndDragCallback;
    public void setListenerDragDrop(System.Action<PointerEventData, Card> _OnBeginDrag, System.Action<PointerEventData, Card> _OnDrag, System.Action<PointerEventData, Card> _OnEndDrag)
    {
