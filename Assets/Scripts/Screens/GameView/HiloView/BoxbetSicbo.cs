...
public class BoxbetSicbo : MonoBehaviour
{
    ...
    [SerializeField]
    public List<TextMeshProUGUI> listLabelBet;
    [SerializeField]
    public bool isHilo = false;
    [HideInInspector]
    public long totalBoxBet = 0;
    ...
    {
        resetDataClickBet();
        sicboGameView.buttonBet.setStateButtonChip();
        sicboGameView.buttonBet.onClickChip(sicboGameView.chipDealLastMatch.ToString());
    }
    ...
    {
        dataClickBet.Clear();
        for (int i = 1, l = listB.Count; i < l; i++)
        {
            if (listB[i] > 0)
            {
                initDataBetSendServer(i, listB[i]);
            }
        }
        setValueLabel();
    }
    private void setValueLabel()
    {
        ...
        for (int i = 0; i < dataClickBet.Count; i++)
        {
            ...
            totalBoxBet += (int)dataClick["value"];
        ...
        if (sicboGameView.buttonBet.label_totalBet)
        {
            //sicboGameView.buttonBet.label_clear.text = Globals.Config.FormatMoney(totalBoxBet);
            sicboGameView.buttonBet.label_totalBet.text = Globals.Config.FormatMoney2(totalBoxBet,true);
        }
    }
    ...
    {
        totalBoxBet = 0;
        sicboGameView.buttonBet.label_totalBet.text = totalBoxBet.ToString();
        //b1 = 0; b2 = 0; b3 = 0; b4 = 0; b5 = 0; b6 = 0; b7 = 0; b8 = 0; b9 = 0; b10 = 0;
        //b11 = 0; b12 = 0; b13 = 0; b14 = 0; b15 = 0; b16 = 0; b17 = 0; b18 = 0; b19 = 0; b20 = 0;
        //b21 = 0; b22 = 0; b23 = 0; b24 = 0; b25 = 0; b26 = 0; b27 = 0; b28 = 0; b29 = 0; b30 = 0; b31 = 0; b32 = 0;
        for (int i = 0, l = listB.Count; i < l; i++)
        {
            listB[i] = 0;
        }
        creatDataClickBet();
    ...
    public void creatDataBet()
    {
        ...
        if (t30 > 0) initData(30, t30);
        if (t31 > 0) initData(31, t31);
        if (t32 > 0) initData(32, t32);
        //for (int i = 1, l = listT.Count; i < l; i++)
        //{
        //    if (listT[i] > 0)
        //    {
        //        initData(i, listT[i]);
