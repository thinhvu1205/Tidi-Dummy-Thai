...
public class LineController : MonoBehaviour
{
    ...
    public void drawRect(Vector2 startPos, float sizeRect, Color colorRect)
    {
        Vector3 A = new Vector3(startPos.x - sizeRect / 2, startPos.y - sizeRect / 2, -1);
        Vector3 B = new Vector3(A.x, A.y + sizeRect, -1);
        Vector3 C = new Vector3(B.x + sizeRect, B.y, -1);
