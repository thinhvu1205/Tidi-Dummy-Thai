...
public class SlotJuicyGardenView : BaseSlotGameView
{
    ...
    [SerializeField]
    protected TextMeshProUGUI lbJpGrand, lbJpMajor, lbJpMinor, lbJpMini, lbTotalPackageValue;
    private int rateJPGrand = 0, rateJPMajor = 0, rateJPMinor = 0, rateJPMini = 0;
    ...
    [SerializeField]
    protected SkeletonGraphic animPopupGetFreeSpin, animPopupResultPackage, animJackpot;
    [SerializeField]
    protected DialogView popupGetFruitRain;
    [SerializeField]
    public GameObject holdPackageContainer;
    [SerializeField]
    protected SkeletonGraphic animToltalMoneyPackage, animEffectPackage;
    [SerializeField]
    protected Material lbJpMaterial_grand, lbJpMaterial_major, lbJpMaterial_minor, lbJpMaterial_mini;
    ...
    {
        //data = GetFakeDataJuicy.instance.getCtableDataBonus6Gio();
        ...
        Debug.Log("Current markbet=" + currentMarkBet);
        setSpinType();
        setStateBtnSpin();
    ...
    public override void setStateBtnSpin()
    {
        ...
        if (gameState == GAME_STATE.SPINNING)
        {
            ...
            {
                animBtnSpin.startingAnimation = "free spin";
            }
    ...
    public override void handleSpin(JObject data)
    {
        ...
        //    indexPick++;
        //}
        //finishData = JObject.Parse("{\"evt\":\"slotViews\",\"slotViews\":[[{\"id\":4,\"value\":0},{\"id\":0,\"value\":0},{\"id\":7,\"value\":0}],[{\"id\":10,\"value\":0},{\"id\":6,\"value\":0},{\"id\":5,\"value\":0}],[{\"id\":5,\"value\":0},{\"id\":5,\"value\":0},{\"id\":2,\"value\":0}],[{\"id\":5,\"value\":0},{\"id\":7,\"value\":0},{\"id\":5,\"value\":0}],[{\"id\":13,\"value\":18000000},{\"id\":8,\"value\":0},{\"id\":12,\"value\":0}]],\"creditWin\":0,\"winningLine\":[],\"lineDetail\":[],\"freeSpinLeft\":0,\"winType\":0,\"freeSpin\":true,\"isBonusGame\":false,\"agWin\":0,\"AG\":265223845799,\"level\":{\"levelUser\":0,\"curLevelExp\":0,\"maxLevelExp\":0,\"agUser\":265223845799},\"MarkBet\":[1,5,50,500,1000,5000,10000,25000,50000,100000,250000,500000],\"jackPot\":{\"typeJP\":\"NONE\",\"winJP\":0},\"allowSelectBonus\":false,\"selectBonus\":{\"typeBonus\":5,\"numSpin\":3,\"view\":[[{\"id\":13,\"value\":91000000},{\"id\":13,\"value\":14000000},{\"id\":10,\"value\":0}],[{\"id\":12,\"value\":0},{\"id\":13,\"value\":55000000},{\"id\":10,\"value\":0}],[{\"id\":12,\"value\":0},{\"id\":13,\"value\":6000000},{\"id\":10,\"value\":0}],[{\"id\":13,\"value\":7000000},{\"id\":12,\"value\":0},{\"id\":10,\"value\":0}],[{\"id\":13,\"value\":5000000},{\"id\":6,\"value\":0},{\"id\":10,\"value\":0}]]},\"lineScatter\":[-1,-1,-1,-1,-1],\"jpGrandPlayer\":50000,\"jpMajorPlayer\":185906}");
        ...
        {
            setValueJPToSlotViews(typeJP, winJP);
        }
    ...
    public override void onStopSpin() //dung het cot cuoi cung.bat dau check data show result c?c th?
    {
        try
        {
            ...
            Debug.Log(" den day roi=" + countTotalAgFreespin);
            ...
            Debug.Log(" den day roi2=" + countTotalAgFreespin);
    ...
    protected override void showBigWin()
    {
        ...
        lbBigWin.transform.localScale = Vector2.one;
    ...
    private void showPopupResultPackage()
    {
        ...
        animPopupResultPackage.AnimationState.SetAnimation(0, "thai", true);
    ...
    protected override void refreshBetRoomAndMarkbet()
    {
        ...
        if ((!isInFreeSpin && !isBonusGame) || (isInFreeSpin == true && !isFreeSpin) || (!isInFreeSpin && isBonusGame&&freespinLeft==0)) //ko co free ,bonus hoac free turn cuoi
        {
            agPlayer = (long)finishData["AG"];
            listBetRoom = getListBetRoom();
